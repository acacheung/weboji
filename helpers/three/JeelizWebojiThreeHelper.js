...
const JeelizWebojiThreeHelper = (function () {
  ...
  function animate(t) {
    ...
    const amortizationCoeff = Math.pow(
      _spec.rotationAmortizationCoeff,
      dt / 16
    );
    ...
    _rotationSpeed[0] +=
      _spec.rotationSpringCoeff * dt * (rotation[0] - _rotationAmortized[0]);
    _rotationSpeed[1] +=
      _spec.rotationSpringCoeff * dt * (rotation[1] - _rotationAmortized[1]);
    _rotationSpeed[2] +=
      _spec.rotationSpringCoeff * dt * (rotation[2] - _rotationAmortized[2]);
    ...
    ThreeMorphAnimGeomBuilder({
      ...
      successCallback: function (geom) {
        ...
        const morphTargetInfluences =
          JEELIZFACEEXPRESSIONS.get_morphTargetInfluencesStabilized();
    ...
    init: function (specArg) {
      ...
      JEELIZFACEEXPRESSIONS.init({
        ...
        callbackReady: function (errCode) {
          ...
          if (_spec.model === null) {
            load_model(_spec.meshURL, false, function () {
